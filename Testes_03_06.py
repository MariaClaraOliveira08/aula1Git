...
#Lista com tipos diferentes de informações de dados 
...
my_list = ["A", "B", "C", "D", "E", "F"]
print(my_list)
new_list = my_list[:3] #Primeiros elementos
print(new_list)
new_list_fim = my_list[5:] #Últimos elementos
print(new_list_fim)
...
# del my_list #apagou da "memória" o my_list
# print(my_list)
...
naosei = ["A", "B", 18, 15]
print(naosei)
print("A" in naosei) #Existe "A" na lista naosei
