...
for i in range(1, len(lista)):
    if lista[i] > maior_numero:
        maior_numero = lista[i] #Acha o maior número da sequência 
...
cubo = [[[":(", "y", "z"],[":)", "y", "z"], [":|", "y", "z"]], [["amor", "ódio", "caridade"], ["paz", "esperança", "férias"], ["tina", "prior", "pp"]], [["restinga", "patrocínio", "rifaina"],["amazonense", "fluminense", "santos"], ["pizza", "lasanha", "pastel"]]]
print(cubo)
print(cubo[1])
print(cubo[1][0])
print(cubo[1][0][2])
